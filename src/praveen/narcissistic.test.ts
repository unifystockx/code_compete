...
describe('testing checkIfNarcissisticNumber function', function () {
  ...
  it('testing if 0 is not NarcissisticNumber ', function () {
    const result = checkIfNarcissisticNumber(0);
    expect(result).toBe(false);
  });
  it('testing if any negative number for eg. -5 is not NarcissisticNumber ', function () {
...
describe('testing getNarcissisticNumbersWithinRange function', function () {
  ...
  it('testing if there is not narcissistic numbers between 200 and 150', function () {
